...
# Kept byte-for-byte so the GR00T-N1.7 `action_head.{state_encoder,action_encoder,
# action_decoder}.*` checkpoint tensors load 1:1. Do not edit layer names/shapes.
#
