...
#
# Vendored VERBATIM into starVLA from Isaac-GR00T (N1.7):
#   gr00t/model/modules/dit.py
# Kept byte-for-byte so the GR00T-N1.7 `action_head.model.*` checkpoint tensors
# load 1:1 into `AlternateVLDiT`. Do not edit the module structure — any change
# to layer names/shapes will break `strict` weight loading. See
# starVLA/model/modules/action_model/GR00T_N1d7_ActionHeader.py for usage.
#
